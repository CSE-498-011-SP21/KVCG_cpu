...
class concurr_traditional_hash_map: public cpu_cache<K, V>{
    ...
    public:
        // Constructor
        concurr_traditional_hash_map(long init_buckets, int init_chain_length, long (*hash0_arg)(K), K (*get_random_K_arg)(), V (*get_random_V_arg)()){
        ...
        concurr_traditional_hash_map(long init_buckets, long (*hash0_arg)(K), K (*get_random_K_arg)(), V (*get_random_V_arg)()) : concurr_traditional_hash_map(init_buckets, 1, hash0_arg, get_random_K_arg, get_random_V_arg){}

        // Deconstructor
        ~concurr_traditional_hash_map(){
            // printTables();
